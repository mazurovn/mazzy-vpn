...
| Desktop Linux | 0.3 candidate; publication blocked by RustSec issue #31 | [#4](https://github.com/mazurovn/mazzy-vpn/issues/4), [#31](https://github.com/mazurovn/mazzy-vpn/issues/31) |
...
Порядок: закрыть RustSec gate #31 для Linux Desktop 0.3 → общий versioned API и
...
Order: close the #31 RustSec gate for Linux Desktop 0.3 → common versioned API
