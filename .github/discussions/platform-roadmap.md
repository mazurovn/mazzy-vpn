...
|---|---|---|
| CLI/TUI | Linux 1.4.0 release source; publication requires its tag and Release page | [#12](https://github.com/mazurovn/mazzy-vpn/issues/12) |
| Desktop Linux | Unsigned 0.4.0 preview source; issue #31 closed, publication requires its tag and Release page | [#4](https://github.com/mazurovn/mazzy-vpn/issues/4) |
...
Порядок: поддерживать закрытый RustSec gate #31 и Linux Desktop 0.4 → общий versioned API и
...
Order: keep the resolved #31 RustSec gate and Linux Desktop 0.4 green → common versioned API
