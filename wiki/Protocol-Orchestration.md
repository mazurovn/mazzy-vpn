...
Stable `v1.4.0` содержит registry, redacted detection, `protocols.list`,
managed import и read-only `planner.evaluate`.
...
Release 1.4 также классифицирует ограниченные sing-box/Xray,
...
Stable `v1.4.0` contains the registry, redacted detection, `protocols.list`,
managed import and read-only `planner.evaluate`.
...
Release 1.4 also classifies bounded sing-box/Xray, official
