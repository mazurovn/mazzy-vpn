...
- The current release line is CLI/TUI `v1.4.7` and DEB-first Desktop
  `desktop-v0.4.8`. Linux Desktop contains and starts its compatible engine
...
- Patch source `1.4.7` / Desktop `0.4.8` makes the Linux Desktop startup path
...
- Windows and macOS 0.4.8 artifacts remain UI previews without native VPN
...
- <https://github.com/mazurovn/mazzy-vpn/releases/tag/v1.4.7>
- <https://github.com/mazurovn/mazzy-vpn/releases/tag/desktop-v0.4.8>
