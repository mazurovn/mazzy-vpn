...
состояния подключения и транзакционные правила. Планируемый versioned local API
отделяет непривилегированный UI от системного VPN backend. Приватные ключи и
...
1. Стабилизировать CLI/TUI 1.2 и Linux Desktop 0.2.
