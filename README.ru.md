...
лицензию, принципы приватности и правила безопасной работы.
...
[PolyForm Noncommercial License 1.0.0](LICENSE). Он **бесплатен для личного,
исследовательского/научного, образовательного и благотворительного
(некоммерческого) использования**. **Коммерческое использование требует
отдельной коммерческой лицензии** — см. [COMMERCIAL.md](COMMERCIAL.md).
Планируется **Enterprise-редакция** поверх этого ядра. Это source-available
ПО, а не OSI-одобренная open-source лицензия; сохраняйте уведомления об
исходном авторстве. Подробнее: [AUTHORS.md](AUTHORS.md) и
